...
' =GerarScript(B3; C3; D3; E3; F3; G3; H3; I3; J3; K3; L3; M3; N3; O3; P3; Q3; R3; S3; T3; U3; V3; W3; X3; Y3; Z3; AA3; AB3)
...
Function GerarScript(TypeName As String, Propriedade1 As String, Propriedade2 As String, TextoAux As String, MetodoAux As String, _
    ...
    VerificarTipoPai As String, AreaDominio As String, AreaDrivers As String, AreaBancoDados As String, _
    ...
    Select Case funcao
        ...
        Case "VerificarObjetoInternoIndevido"
        ...
        Case "VerificarPropriedadeTextoProibido"
            GerarScript = funcao & " Obj, """ & TypeName & """, """ & Propriedade1 & """, " & TextoAux & ", """ & area & """, " & nivel
        Case "VerificarBancoDeDados"
            GerarScript = funcao & " Obj, """ & TypeName & """, """ & Propriedade1 & """, """ & area & """, " & nivel
        Case "ContarObjetosDoTipo", "VerificarUserFields", "VerificarCamposUsuariosServidorAlarmes"
            GerarScript = funcao & " Obj, """ & TypeName & """, """ & area & """, " & nivel
